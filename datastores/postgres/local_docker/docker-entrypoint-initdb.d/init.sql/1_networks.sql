...
ALTER TABLE "public"."protocol_networks" ADD CONSTRAINT "protocol_networks_pk" PRIMARY KEY ("protocol_network_id");
ALTER TABLE "public"."protocol_networks" ADD CONSTRAINT "protocol_networks_unique" UNIQUE("protocol_name", "network_name");

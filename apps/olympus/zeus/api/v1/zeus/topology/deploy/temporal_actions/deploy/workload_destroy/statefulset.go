...
func DestroyDeployStatefulSetHandlerWrapper(k autok8s_core.K8Util) func(c echo.Context) error {
	return func(c echo.Context) error {
		...
		if request.Kns.TopologyBaseInfraWorkload.StatefulSet != nil {
			err := k.DeleteStatefulSet(ctx, request.Kns.CloudCtxNs, request.Kns.TopologyBaseInfraWorkload.StatefulSet.Name, nil)
			if err != nil {

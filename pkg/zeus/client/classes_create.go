...
func (z *ZeusClient) CreateClass(ctx context.Context, tar zeus_req_types.TopologyCreateOrAddSkeletonBasesToClassesRequest) (topology_workloads.TopologyCreateClassResponse, error) {
	z.PrintReqJson(tar)

...
func convertBeaconAPIBalancesToModelBalance(epoch int64, beaconBalanceAPI api_types.ValidatorBalances, valBalances beacon_models.ValidatorBalancesEpoch) beacon_models.ValidatorBalancesEpoch {

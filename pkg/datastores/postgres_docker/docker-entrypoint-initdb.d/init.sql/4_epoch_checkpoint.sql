CREATE TABLE "public"."epoch_checkpoint" (
     "validator_balance_epoch" serial NOT NULL REFERENCES validator_balances_at_epoch(epoch),
...
;
ALTER TABLE "public"."epoch_checkpoint" ADD CONSTRAINT "validator_balances_remaining_at_epoch_pkey" PRIMARY KEY ("validator_balance_epoch","validators_balances_remaining");

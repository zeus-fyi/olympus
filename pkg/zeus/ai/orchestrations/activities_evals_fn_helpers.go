		...
		for i, _ := range jsonSchemaDef.Fields[vi].EvalMetrics {
			...
			case "integer":
				...
				if jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonInteger != nil {
					...
					eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %d", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, aws.ToInt(jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonInteger))
				} else if jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber != nil {
					eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %d", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, int(aws.ToFloat64(jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber)))
			...
			case "number":
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %f", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, aws.ToFloat64(jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber))
			...
			case "string":
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %s", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, aws.ToString(jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonString))
			...
			case "boolean":
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %t", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, aws.ToBool(jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonBoolean))
			...
			case "array[integer]":
				...
				if jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonInteger != nil {
					...
					eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %d", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, int(*jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber))
					jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricResult.EvalResultOutcomeBool = aws.Bool(Pass(results))
				}
			case "array[number]":
				if jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber == nil {
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %f", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, *jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonNumber)
				jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricResult.EvalResultOutcomeBool = aws.Bool(Pass(results))
			case "array[string]":
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %s", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, *jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonString)
				jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricResult.EvalResultOutcomeBool = aws.Bool(Pass(results))
			case "array[boolean]":
				...
				eocr.EvalOpCtxStr = fmt.Sprintf("%s %s %t", jsonSchemaDef.Fields[vi].FieldName, jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalOperator, *jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricComparisonValues.EvalComparisonBoolean)
				jsonSchemaDef.Fields[vi].EvalMetrics[i].EvalMetricResult.EvalResultOutcomeBool = aws.Bool(Pass(results))
			default:

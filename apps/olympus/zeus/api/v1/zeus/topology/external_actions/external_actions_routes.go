...
import (
	...
	"github.com/zeus-fyi/olympus/zeus/api/v1/zeus/topology/external_actions/config_maps"
	"github.com/zeus-fyi/olympus/zeus/api/v1/zeus/topology/external_actions/nodes"
...
func ExternalActionsRoutes(e *echo.Group, k8Cfg autok8s_core.K8Util) *echo.Group {
	...
	e = nodes.ExternalApiNodesRoutes(e, k8Cfg)
	e = pods.ExternalApiPodsRoutes(e, k8Cfg)
	e = config_maps.ConfigMapActionRequestRoutes(e)
	return e
}

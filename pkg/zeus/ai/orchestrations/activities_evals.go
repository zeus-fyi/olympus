...
func (z *ZeusAiPlatformActivities) EvalModelScoredJsonOutput(ctx context.Context, schemas [][]*artemis_orchestrations.JsonSchemaDefinition) (*artemis_orchestrations.EvalMetricsResults, error) {
	if schemas == nil {

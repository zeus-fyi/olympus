...
type HestiaCookbookTestSuite struct {
...
func (t *HestiaCookbookTestSuite) SetupTest() {
...
func TestHestiaCookbookTestSuite(t *testing.T) {
	suite.Run(t, new(HestiaCookbookTestSuite))
}

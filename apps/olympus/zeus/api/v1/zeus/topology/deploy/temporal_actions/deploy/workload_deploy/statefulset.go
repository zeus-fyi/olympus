...
func DeployStatefulSetHandlerWrapper(k autok8s_core.K8Util) func(c echo.Context) error {
	return func(c echo.Context) error {
		...
		if request.Kns.TopologyBaseInfraWorkload.StatefulSet != nil {
			...
			_, err := k.CreateStatefulSetIfVersionLabelChangesOrDoesNotExist(ctx, request.Kns.CloudCtxNs, request.Kns.TopologyBaseInfraWorkload.StatefulSet, nil)
			if err != nil {

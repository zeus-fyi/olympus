...
func (t *TopologySkeletonBaseComponents) GetRowValues(queryName string) apps.RowValues {
	...
	switch queryName {
	default:
		pgValues = apps.RowValues{t.OrgID, t.TopologyBaseComponentID, t.TopologyClassTypeID, t.TopologySkeletonBaseVersionID, t.TopologySkeletonBaseName}
	}
	return pgValues
}
func (t *TopologySkeletonBaseComponents) GetTableColumns() (columnValues []string) {
	columnValues = []string{"org_id", "topology_base_component_id", "topology_class_type_id", "topology_skeleton_base_version_id", "topology_skeleton_base_name"}
	return columnValues
}

...
func (a *AuxiliaryTradingUtils) GenerateTradeV2SwapFromTokenToToken(ctx context.Context, w3c web3_client.Web3Client, ur *web3_client.UniversalRouterExecCmd, to *artemis_trading_types.TradeOutcome) (*web3_client.UniversalRouterExecCmd, *artemis_eth_txs.Permit2Tx, error) {
	...
	psp, pt, err := a.generatePermit2Approval(ctx, w3c, to)
	if err != nil {

...
func InsertSkeletonBase(ctx context.Context, skeletonBase *skeletons.SkeletonBase) error {
	...
	err := apps.Pg.QueryRowWArgs(ctx, q.RawQuery, skeletonBase.OrgID, skeletonBase.TopologyBaseComponentID, class_types.SkeletonBaseClassTypeID, skeletonBase.TopologySkeletonBaseName).Scan(&skeletonBase.TopologySkeletonBaseVersionID)

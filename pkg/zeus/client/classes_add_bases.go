...
func (z *ZeusClient) AddBasesToClass(ctx context.Context, tar zeus_req_types.TopologyCreateClusterRequest) (topology_workloads.TopologyCreateClassResponse, error) {
	z.PrintReqJson(tar)

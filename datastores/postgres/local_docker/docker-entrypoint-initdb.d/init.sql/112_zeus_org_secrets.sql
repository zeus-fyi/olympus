...
ALTER TABLE "public"."topology_system_components_secrets" ADD CONSTRAINT "topology_system_components_secrets_pk" PRIMARY KEY ("topology_system_component_id", "secret_id");

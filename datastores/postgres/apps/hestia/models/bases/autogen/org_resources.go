...
type OrgResources struct {
	...
	OrgResourceID int          `db:"org_resource_id" json:"orgResourceID"`
}
...
func (o *OrgResources) GetRowValues(queryName string) apps.RowValues {
	...
	switch queryName {
	default:
		pgValues = apps.RowValues{o.EndService, o.ResourceID, o.OrgID, o.BeginService, o.Quantity, o.FreeTrial, o.OrgResourceID}
	}
	return pgValues
}
func (o *OrgResources) GetTableColumns() (columnValues []string) {
	columnValues = []string{"end_service", "resource_id", "org_id", "begin_service", "quantity", "free_trial", "org_resource_id"}
	return columnValues
}

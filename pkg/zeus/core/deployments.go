...
func (k *K8Util) CreateDeployment(ctx context.Context, kns KubeCtxNs, d *v1.Deployment, filter *string_utils.FilterOpts) (*v1.Deployment, error) {
...
func (k *K8Util) CreateDeploymentIfVersionLabelChangesOrDoesNotExist(ctx context.Context, kns KubeCtxNs, nd *v1.Deployment, filter *string_utils.FilterOpts) (*v1.Deployment, error) {

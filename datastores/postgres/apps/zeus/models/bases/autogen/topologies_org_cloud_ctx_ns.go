...
func (t *TopologiesOrgCloudCtxNs) GetRowValues(queryName string) apps.RowValues {
	...
	switch queryName {
	default:
		pgValues = apps.RowValues{t.CloudCtxNsID, t.OrgID, t.CloudProvider, t.Context, t.Region, t.Namespace}
	}
	return pgValues
}
func (t *TopologiesOrgCloudCtxNs) GetTableColumns() (columnValues []string) {
	columnValues = []string{"cloud_ctx_ns_id", "org_id", "cloud_provider", "context", "region", "namespace", "created_at"}
	return columnValues
}
